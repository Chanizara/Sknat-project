      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 pt-8 pb-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 space-y-10">
            ...
            <div className="bg-white rounded-[2rem] p-8 shadow-[0_26px_55px_-34px_rgba(15,23,42,0.62)]">
              ...
              <div className="border-t border-gray-200 pt-6 mb-6">
                ...
                {property.pricePerSqm ? (
                  <p className="text-gray-500">{formatPrice(property.pricePerSqm)}/ตร.ม.</p>
                ) : null}
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                {property.size ? (
                  <div className="bg-gray-50 rounded-xl p-4">
                    <p className="text-gray-500 text-sm mb-1">ขนาดพื้นที่</p>
                    <p className="text-xl font-semibold text-gray-900">{property.size} ตร.ม.</p>
                  </div>
                ) : null}
                {property.bedrooms ? (
                  <div className="bg-gray-50 rounded-xl p-4">
                    <p className="text-gray-500 text-sm mb-1">ห้องนอน</p>
                    <p className="text-xl font-semibold text-gray-900">{property.bedrooms}</p>
                  </div>
                ) : null}
                {property.bathrooms ? (
                  <div className="bg-gray-50 rounded-xl p-4">
                    <p className="text-gray-500 text-sm mb-1">ห้องน้ำ</p>
              ...
              {property.description ? (
                <div className="mb-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-3">รายละเอียดเพิ่มเติม</h2>
              ...
              {property.features && property.features.length > 0 ? (
                <div>
                  <h2 className="text-xl font-bold text-gray-900 mb-3">จุดเด่น</h2>
            ...
            <div className="bg-white rounded-[2rem] p-8 shadow-[0_26px_55px_-34px_rgba(15,23,42,0.62)]">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">สถานที่ตั้ง</h2>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">สถานีรถไฟฟ้าใกล้ที่สุด</p>
                      <p className="text-sm text-gray-600">ห่างประมาณ 1.2 กม.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">ห้างสรรพสินค้า</p>
                      <p className="text-sm text-gray-600">ห่างประมาณ 2.5 กม.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">โรงเรียน</p>
                      <p className="text-sm text-gray-600">ห่างประมาณ 800 ม.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">โรงพยาบาล</p>
                      <p className="text-sm text-gray-600">ห่างประมาณ 3.0 กม.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-white rounded-[2rem] p-6 shadow-[0_26px_55px_-34px_rgba(15,23,42,0.62)]">
              <h2 className="text-xl font-bold text-gray-900 mb-6">ติดต่อสอบถาม</h2>
              ...
              {property.agent ? (
                <div className="space-y-6">
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <p className="text-sm text-gray-500">ติดต่อสอบถาม</p>
                  ...
                  <div className="space-y-3">
                    {property.agent.phone ? (
                      ...
                      >
                        ...
                        <div>
                          <p className="text-xs text-gray-500">โทร</p>
                          <p className="font-medium text-gray-900">{property.agent.phone}</p>
                        </div>
                      </a>
                    ) : null}
                    ...
                    {property.agent.email ? (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900 text-sm truncate">{property.agent.email}</p>
                        </div>
                      </a>
                    ) : null}
                  </div>
                  ...
                  <button
                    type="button"
                    className="w-full py-3 bg-green-600 text-white rounded-full font-semibold hover:bg-green-700 transition flex items-center justify-center gap-2"
                  >
                ...
                <div className="text-center py-8">
                  <p className="text-gray-500">ไม่มีข้อมูลผู้ติดต่อ</p>
                </div>
              )}

              {property.updatedAt ? (
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <p className="text-xs text-gray-500 text-center">{formatUpdatedAt(property.updatedAt)}</p>
                </div>
              ) : null}
            </div>
          </div>
