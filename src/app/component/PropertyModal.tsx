      ...
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 mb-6 border-b border-gray-200">
            <button className="px-4 py-2 bg-gray-900 text-white rounded-t-lg font-medium">
              พร้อมสระน้ำ
            </button>
            <button className="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-t-lg font-medium">
              {property.type}
            </button>
            <button className="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-t-lg font-medium">
            ...
            <div>
              ...
              <div className="bg-blue-50 rounded-lg p-5 mb-4">
                ...
                {property.pricePerSqm && (
                  <div className="text-sm text-gray-600">
                    ฿{property.pricePerSqm.toLocaleString()}/ตร.ม.
                  </div>
                )}
                {property.type === 'เช่า' && (
                  <div className="text-sm text-gray-500 mt-1">(ประจำเดือน)</div>
                )}
                {property.type === 'ขาย' && property.price && (
                  <div className="text-sm text-gray-500 mt-1">
                    ฿{(parseFloat(property.price.replace(/[฿,]/g, '')) * 0.75).toLocaleString()} (ประมาณ)
                  </div>
                )}
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center justify-between py-2 border-b border-gray-200">
                  ...
                  <span className="font-semibold text-gray-900">{property.size} ตร.ม.</span>
                </div>
                {property.bedrooms && (
                  <div className="flex items-center justify-between py-2 border-b border-gray-200">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-xs text-gray-500">
                  รหัสทรัพย์สิน: p{String(property.id).padStart(3, '0')}
                </p>
                <p className="text-xs text-gray-500 mt-1">
                  ข้อมูลปรับปรุง: {new Date().toLocaleDateString('th-TH')}
                </p>
              </div>
            </div>
          </div>
